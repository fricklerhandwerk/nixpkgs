...
rec {
  ...
  redirects-nixpkgs = pkgs.callPackage ./redirects-check.nix { redirectsFile = "doc/redirects.json"; };
  redirects-nixos = pkgs.callPackage ./redirects-check.nix { redirectsFile = "nixos/doc/manual/redirects.json"; };
